  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Nelson Ivan Rodriguez Rivas</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <!--<li class="user-header">
                    ...
                    <p>
                      www.url del sistema de ventas.com - Desarrollando Software
                      <small>www.youtube.SisVentas</small>
                    </p>
                  </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018-2020 Nelson Rodriguez</strong> All rights reserved.
      </footer>
